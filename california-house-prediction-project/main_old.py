...
# Calculate RMSE
# )
# tree_rmse = root_mean_squared_error(housing_labels, dec_preds)
# forest_rmse = root_mean_squared_error(housing_labels, forest_preds)
# print("Linear Regression RMSE:", lin_rmse)
# print("Decision Tree RMSE:", dec_rmse)
# print("Random Forest RMSE:", forest_rmse)  #these give high rmse with overfittied data so we cant use these so we have to use cross validation method
